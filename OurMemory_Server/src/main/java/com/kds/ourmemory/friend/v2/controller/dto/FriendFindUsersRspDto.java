...
@ApiModel(value = "FriendFindUsersRspDto", description = "Find Users Response Dto")
@Getter
public class FriendFindUsersRspDto {
    ...
    public FriendFindUsersRspDto(FriendRspDto friendRspDto) {
