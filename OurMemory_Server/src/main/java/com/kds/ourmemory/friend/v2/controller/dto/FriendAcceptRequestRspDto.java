...
@ApiModel(value = "FriendAcceptRequestRspDto", description = "RequestFriend Accept Response Dto")
@Getter
public class FriendAcceptRequestRspDto {
    ...
    public FriendAcceptRequestRspDto(FriendRspDto friendRspDto) {
