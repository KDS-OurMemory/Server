package com.kds.ourmemory.memory.v2.controller;
...
@RestController
@RequestMapping(value = "/v2/memories")
public class MemoryV2Controller {
    ...
    @PostMapping
    public ApiResult<MemoryInsertRspDto> insert(@RequestBody MemoryInsertReqDto reqDto) {
        return ok(memoryV2Service.insert(reqDto));
    }
    ...
    public ApiResult<MemoryFindRspDto> findMemory(
            @PathVariable long memoryId,
            @PathVariable long roomId
    ) {
        return ok(memoryV2Service.find(memoryId, roomId));
    }
