...
import com.kds.ourmemory.memory.v1.controller.dto.ShareType;
...
@ApiModel(value = "MemoryInsertReqDto", description = "Insert Memory Request Dto")
@Getter
@Builder
@AllArgsConstructor
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class MemoryInsertReqDto {
    ...
    public MemoryReqDto toDto() {
        return MemoryReqDto.builder()
                .userId(userId)
                .roomId(roomId)
                .name(name)
                .contents(contents)
