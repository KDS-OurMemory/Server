...
@ApiModel(value = "UserPatchTokenRspDto", description = "Patch Token Response Dto")
@Getter
public class UserPatchTokenRspDto {
    ...
    public UserPatchTokenRspDto(UserRspDto userRspDto) {
