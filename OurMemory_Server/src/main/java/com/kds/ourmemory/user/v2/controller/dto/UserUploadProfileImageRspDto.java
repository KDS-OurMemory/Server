...
@ApiModel(value = "UserUploadProfileImageRspDto", description = "Upload ProfileImage Response Dto")
@Getter
public class UserUploadProfileImageRspDto {
    ...
    public UserUploadProfileImageRspDto(UserRspDto userRspDto) {
